...
- **S3 轨道/支撑仍是运行时圆柱结构，车体缺失**：`ACoasterRideActor` 仍承担 rails/ties/supports 的可见几何；隐藏车体 placeholder 已删除，当前没有 authored cockpit/train/安全杆。相对山体/江水不是第一优先级，但 D 阶段不能标 Done。
