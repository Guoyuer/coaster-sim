...
|---|---|---|---|---|
| 2026-06-19 | [`p0-p1`](../reviews/2026-06-19-p0-p1.md) | PASS（有条件） | Open | P0/P1 真落地、不穿山阻断已闭环；**乘坐舒适门禁已由 P3 真实速度剖面 + banking 后 G 闭环**；仍 Open：**风景未验证**（overlay 糊看不出贴江），景观相关不得标 Done |
...
- [ ] **【外审 p0-p1 建议】P3 几何/节奏收口**：曲率 banking + 真实速度门禁已完成；下一步不再是“过不过门槛”，而是 D9 体验：当前 `vert_g=0.87/1.02` 偏平，需调出更明显俯冲/airtime/返程爬升节奏；`DistanceToTrack2D` 双表示在清理时消灭（spec §6.0 未做）；P0 可补前/后英雄帧 diff 彻底收口零回归。
- [ ] **【重定位 2026-06-19】P4–P5**：走廊照片化(含环境迁出) / 验收增 D9 D10。依赖 P3 体验收口。
